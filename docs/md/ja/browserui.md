...
| <span class="material-symbols-outlined">wb_iridescent</span> | 画面スリープ防止 | 待機状態で画面が暗くならないように設定します。 |
| <span class="material-symbols-outlined">closed_caption</span> | 字幕表示 | 画面下部にインゲーム音声の字幕を表示または非表示にします。 |
| <span class="material-symbols-outlined">logout</span> | ログアウト | ゲームでログアウトし、メイン画面に戻ります。 |
