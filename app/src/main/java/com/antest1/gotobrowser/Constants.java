...
public class Constants {
    ...
    public static final String RESIZE_OSAPI = "function resize(){$(\"#spacing_top\").remove(),$(\"#sectionWrap\").hide(),$(\"body\")[0].style.backgroundColor=\"#040203\",$(\"body\")[0].style.overflow=\"hidden\",$(\"body\")[0].style.margin=\"0px\",$(\"body\")[0].style.padding=\"0px\";var a=1200,b=720,c=window.innerWidth,d=window.innerHeight;a/b<c/d&&$(\"#flashWrap iframe\").css(\"padding\",\"0 45px\"),console.log(a+\" \"+b+\" / \"+c+\" \"+d)}setTimeout(resize,1500);";
