...
public class Constants {
    ...
    public static final String PREF_LOCALPROXY = "pref_localproxy";
    ...
    public static final String RESIZE_OOI_1 = "var width=1200,height=720,game_ratio=width/height;function resize(e,a){resize_triggered=!0;var i=window.innerWidth,o=window.innerHeight;game_ratio<i/o?($(\"#game_frame\").css(\"padding\",\"0 \"+e+\"px\"),$(\"body\").css(\"padding-top\",\"0px\")):($(\"#game_frame\").css(\"padding\",\"0px\"),$(\"body\").css(\"padding-top\",a+\"px\"))}$(\"#externalswf\").attr(\"id\",\"game_frame\"),$(\"#ooi-header, #ooi-footer, #ooi-game a, .uk-modal, .statistics\").remove(),$(\"#page, body\").css(\"background-color\",\"black\"),$(\"#ooi-page, #ooi-content, #ooi-game\").css(\"margin\",\"0\"),$(\"#ooi-page, #ooi-content, #ooi-game\").css(\"padding\",\"0\"),$(\"#game_frame\").css(\"margin-top\",\"-16px\"),$(\"#game_frame\").height(736);var chk=setInterval(function(){736!=$(\"#game_frame\").height()&&($(\"#game_frame\").height(736),console.log(\"resize\"),clearInterval(chk))},100);resize_triggered=!1,setTimeout(resize,300,%d,%d);";
